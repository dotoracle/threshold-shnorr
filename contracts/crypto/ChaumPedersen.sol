...
library ChaumPedersen
{
	...
	function CreateProof(Curve.G1Point memory G, Curve.G1Point memory H, uint256 secret, uint256 message )
	    view internal
	    returns (Curve.G1Point memory out_G, Curve.G1Point memory out_H, uint256[2] memory out_xG, uint256[2] memory out_xH, uint256 out_s, uint256 out_e)
	{
	    out_G = G;
	    out_H = H;
	...
	function CalcProof(Curve.G1Point memory G, Curve.G1Point memory H, Curve.G1Point memory xG, Curve.G1Point memory xH, uint256 message, uint256 s, uint256 e )
	    view internal
	    returns (uint256)
	{
	...
	function VerifyProof(Curve.G1Point memory G, Curve.G1Point memory H, Curve.G1Point memory xG, Curve.G1Point memory xH, uint256 message, uint256 s, uint256 e )
	    view internal
	    returns (bool)
	{
